...
/**
 * Gap/CFS Feature Page: No dentist/customer communication-template library.
 * Slug: no-dentist-customer-communication-template-library
 * Backend: /api/gap-no-dentist-customer-communication-template-library
 */
export default function NoDentistCustomerCommunicationTemplateLibraryPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-dentist-customer-communication-template-library', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No dentist/customer communication-template library.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No dentist/customer communication-template library.</p>
