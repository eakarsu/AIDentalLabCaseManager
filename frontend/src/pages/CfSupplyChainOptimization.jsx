...
/**
 * Gap/CFS Feature Page: Supply chain optimization
 * Slug: supply-chain-optimization
 * Backend: /api/cf-supply-chain-optimization
 */
export default function SupplyChainOptimizationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-supply-chain-optimization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Supply chain optimization</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Predict material needs; auto-order based on case pipeline.</p>
