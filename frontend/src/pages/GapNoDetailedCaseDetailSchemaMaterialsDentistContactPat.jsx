...
/**
 * Gap/CFS Feature Page: No detailed case-detail schema (materials, dentist contact, patient, delivery date).
 * Slug: no-detailed-case-detail-schema-materials-dentist-contact-pat
 * Backend: /api/gap-no-detailed-case-detail-schema-materials-dentist-contact-pat
 */
export default function NoDetailedCaseDetailSchemaMaterialsDentistContactPatPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-detailed-case-detail-schema-materials-dentist-contact-pat', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No detailed case-detail schema (materials, dentist contact, patient, delivery date).</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No detailed case-detail schema (materials, dentist contact, patient, delivery date).</p>
