...
/**
 * Gap/CFS Feature Page: Quality scoring
 * Slug: quality-scoring
 * Backend: /api/cf-quality-scoring
 */
export default function QualityScoringPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-quality-scoring', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Quality scoring</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Predict quality issues before completion; recommend inspection focus areas.</p>
