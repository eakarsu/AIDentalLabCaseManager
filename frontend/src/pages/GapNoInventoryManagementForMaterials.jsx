...
/**
 * Gap/CFS Feature Page: No inventory management for materials.
 * Slug: no-inventory-management-for-materials
 * Backend: /api/gap-no-inventory-management-for-materials
 */
export default function NoInventoryManagementForMaterialsPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-inventory-management-for-materials', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No inventory management for materials.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No inventory management for materials.</p>
