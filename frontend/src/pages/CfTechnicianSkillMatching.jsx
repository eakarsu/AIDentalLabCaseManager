...
/**
 * Gap/CFS Feature Page: Technician skill matching
 * Slug: technician-skill-matching
 * Backend: /api/cf-technician-skill-matching
 */
export default function TechnicianSkillMatchingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-technician-skill-matching', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Technician skill matching</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Assign cases to technicians based on expertise and current workload.</p>
