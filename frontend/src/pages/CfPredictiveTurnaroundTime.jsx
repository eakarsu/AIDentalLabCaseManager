...
/**
 * Gap/CFS Feature Page: Predictive turnaround time
 * Slug: predictive-turnaround-time
 * Backend: /api/cf-predictive-turnaround-time
 */
export default function PredictiveTurnaroundTimePage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-predictive-turnaround-time', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Predictive turnaround time</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>ML model estimates case delivery time based on complexity, current queue, technician capacity.</p>
