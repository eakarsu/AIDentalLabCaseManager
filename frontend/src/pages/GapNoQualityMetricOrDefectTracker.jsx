...
/**
 * Gap/CFS Feature Page: No quality-metric or defect tracker.
 * Slug: no-quality-metric-or-defect-tracker
 * Backend: /api/gap-no-quality-metric-or-defect-tracker
 */
export default function NoQualityMetricOrDefectTrackerPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-quality-metric-or-defect-tracker', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No quality-metric or defect tracker.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No quality-metric or defect tracker.</p>
