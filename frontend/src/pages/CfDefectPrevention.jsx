...
/**
 * Gap/CFS Feature Page: Defect prevention
 * Slug: defect-prevention
 * Backend: /api/cf-defect-prevention
 */
export default function DefectPreventionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-defect-prevention', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Defect prevention</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Analyze historical defect patterns; recommend preventive measures for high-risk cases.</p>
